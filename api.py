...
id_digito_verificacion = "vistaConsultaEstadoRUT:formConsultaEstadoRUT:dv"
app = Flask(__name__)
...
def scrape():
    ...
    try:
        ...
        # Obtener el dígito de verificación
        digito_verificacion = driver.find_element(By.ID, id_digito_verificacion).text if driver.find_elements(By.ID, id_digito_verificacion) else None
